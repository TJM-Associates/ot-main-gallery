...
const imagesCV = fs.createWriteStream('./database/cassandra/cassandra.csv');
imagesCV.write('r_ri,i_id,resturant_name,url,source,picture_date,photographer,name\n', 'utf8');
...
const writeData = (writer, encoding, callback) => {
  ...
  const write = () => {
    ...
    while (i > 0 && ok) {
      ...
      const data = `${rId},${iId},${restaurantName},${randomImageUrl},${source},${pictureDate},${photographer},${name}\n`;
      if (i === 0) {
